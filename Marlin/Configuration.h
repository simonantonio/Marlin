...
#define STRING_CONFIG_H_AUTHOR "(aurum stratum, s.antonio)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Aurum Stratum"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "C0FFEE00-C0DE-4f1a-8ecb-bb943d372f65"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.63, 84.21, 1600, 419 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
//these are slower to get better prints - @todo look at how fast we can go without reducing quality
...
#define X_BED_SIZE 260  //330
#define Y_BED_SIZE 310  //330
 ...
 */
/* need to offset the probes offset to nozzle */

//#define X_PROBE_OFFSET_FROM_EXTRUDER -32  // X offset: -left  +right  [of the nozzle]
//#define Y_PROBE_OFFSET_FROM_EXTRUDER -10  // Y offset: -front +behind [the nozzle]

#if EITHER(AUTO_BED_LEVELING_3POINT, AUTO_BED_LEVELING_UBL)
  #define PROBE_PT_1_X 51
  #define PROBE_PT_1_Y 40
  #define PROBE_PT_2_X 181
  #define PROBE_PT_2_Y 40
  #define PROBE_PT_3_X 178
  #define PROBE_PT_3_Y 176
#endif
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_X_POINT 63 //(83-32)
  //#define Z_SAFE_HOMING_Y_POINT 11 //(50-10)
#endif
